...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2423881075ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=blog&table=likes">`blog`.`likes`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=blog&table=reactions">`blog`.`reactions`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=blog&table=posts">`blog`.`posts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=blog&table=users">`blog`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=blog&table=views">`blog`.`views`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=blog&table=topics">`blog`.`topics`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=validate&table=v">`validate`.`v`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=resultdb&table=result">`resultdb`.`result`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=counter&table=visitor_counter">`counter`.`visitor_counter`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=validate&table=valid">`validate`.`valid`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
